...
class Simulations():
    def __init__(self,
                 system,
                 integrator, # diffeq = NoseHooverChain
                 wrap=True,
                 method="NH_verlet"
                 ):
        ...
        self.solvemethod = method # NH_verlet
        self.wrap = wrap
        self.keys = self.integrator.state_keys # self.state_keys = ['velocities', 'positions', 'baths']
        self.initialize_log()
